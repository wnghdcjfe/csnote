...
신뢰성이 높은 강점이 있습니다. 
참고로 멀티프로세싱은 하드웨어 관점에서 봤을 때 여러 개의 프로세서로 작업을 처리하는 것을 의미하기도 합니다. 이 책에서는 멀티스레딩과 멀티프로세싱을 비교하고 있고 그 다음으로 멀티프로세스 구조를 가진 브라우저를 예시로 들고 있기 때문에 소프트웨어 관점에서 용어를 썼습니다.     
